...
PATH = PATH_to_repo + "Rock_Cuttings_Characterisation/Models/Results/model_10/model_*"
...
for model_number, path_model in enumerate(glob.glob(PATH)):
    ...
    # Load data
    df_path = pd.read_csv('comparison_data_new.csv', index_col = 0)
    ...
    df_path['best_model_'+str(model_number)] = preds_vec
    df_path['best_model_time_'+str(model_number)] = time_vec
    df_path.to_csv('comparison_data_new.csv')